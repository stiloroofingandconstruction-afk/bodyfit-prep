...
import { compareMetrics, DIRECTION_TONE, type MetricComparison } from '@bodyfit/domain/weeklySummary';
import { PROJECTION_LABEL, PROJECTION_TONE } from '@bodyfit/domain/competition';
